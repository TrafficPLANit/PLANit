...
public class sLtmTaBushMultiDestinationQlFdTest extends sLtmAssignmentMultiDestinationTestBase {
  ...
  private void testDeterministicOutputs(StaticLtm sLTM) {
    ...
    assertEquals(outflow4, 3738.756691825307, Precision.EPSILON_2);
    ...
    assertEquals(outflow8, 3761.2433081746935, Precision.EPSILON_2);
    ...
    assertEquals(outflow13, 2238.756691825307, Precision.EPSILON_2);
    assertEquals(outflow14, 2261.2433081746935, Precision.EPSILON_2);
