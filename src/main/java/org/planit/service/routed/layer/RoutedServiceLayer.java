package org.planit.service.routed.layer;
 ...
 *
 */
public class RoutedServiceLayer extends TopologicalLayerImpl implements TopologicalLayer {

  /** the logger */
  private static final Logger LOGGER = Logger.getLogger(RoutedServiceLayer.class.getCanonicalName());
  ...
  private PhysicalLayer<? extends Node, ? extends Link, ? extends LinkSegment> parentNetworkLayer;
   ...
   */
  protected void setParentNetworkLayer(final PhysicalLayer<? extends Node, ? extends Link, ? extends LinkSegment> parentNetworkLayer) {
   ...
   */
  public RoutedServiceLayer(final IdGroupingToken tokenId, final ServiceNetworkLayerBuilder serviceNetworkLayerBuilder) {
   ...
   * @param serviceNetworkLayerBuilder this is the builder to use for this layer
   */
  protected RoutedServiceLayer(final IdGroupingToken tokenId, final PhysicalLayer<? extends Node, ? extends Link, ? extends LinkSegment> parentNetworkLayer,
      final ServiceNetworkLayerBuilder serviceNetworkLayerBuilder) {
    super(tokenId);
    this.parentNetworkLayer = parentNetworkLayer;
   ...
   * @return the nodes
   */
  public final ServiceNodes<ServiceNode> getNodes() {
    return serviceNodes;
  }
  ...
  public long getNumberOfLinkSegments() {
    return serviceLegSegments.size();
  }
}
