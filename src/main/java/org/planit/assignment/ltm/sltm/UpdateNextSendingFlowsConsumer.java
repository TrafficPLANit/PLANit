...
public class UpdateNextSendingFlowsConsumer implements ApplyToNodeModelResult {
   ...
   */
  @Override
  public void accept(final DirectedVertex potentiallyBlockingNode, final Array1D<Double> localFlowAcceptanceFactor, final TampereNodeModel nodeModel) throws PlanItException {
