...
public interface LinkVolumeAccessor extends InteractorAccessor, EventListenerInterface {
  ...
  /**
   * event type fired off when a new request for an interactor of type link volume accessee is
   * created
   */
  public static final EventType INTERACTOR_REQUEST_LINKVOLUMEACCESSEE_TYPE = new EventType(
      "INTERACTOR.REQUEST.LINKVOLUMEACCESSEE.TYPE");
