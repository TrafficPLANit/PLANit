...
public interface LinkVolumeAccessee extends InteractorAccessee {
  ...
  /**
   * event type fired off when this accessee is identified as a suitable candidate for an accessee
   * request
   */
  public static final EventType INTERACTOR_PROVIDE_LINKVOLUMEACCESSEE = new EventType(
