...
public interface RouteOutputTypeAdapter extends OutputTypeAdapter {
   ...
   */
  public Object getRouteOutputPropertyValue(OutputProperty outputProperty, ODRouteIterator odPathIterator, Mode mode,
      TimePeriod timePeriod, RouteIdType pathOutputType);
}
