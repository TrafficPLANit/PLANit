...
public interface OutputTypeAdapter {
	...
	/**
	 * Determine the iteration index that is relevant for the data related to the provided output type enum
	 * Generally, this equates to the actual current iteration index, but if the data for example is trailing an iteration
	 * then this will collect the correct iteration index for this data as opposed to the iteration index of the simulation itself.
