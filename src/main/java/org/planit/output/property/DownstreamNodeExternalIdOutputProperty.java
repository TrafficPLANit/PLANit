...
public final class DownstreamNodeExternalIdOutputProperty extends BaseOutputProperty {
	...
	public static final String DOWNSTREAM_NODE_EXTERNAL_ID = "Downstream Node External Id";
	...
	public Object getValue(Object object, TrafficAssignment trafficAssignment, Mode mode, TimePeriod timePeriod, double timeUnitMultiplier) throws PlanItException {
		if (!(object instanceof LinkSegment)) {
			throw new PlanItException("Tried to read downstream node external Id of an object which is not a link segment.");
		}
