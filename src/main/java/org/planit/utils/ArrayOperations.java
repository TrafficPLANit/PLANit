 ...
 * @param addToDestination			array of values to be added to destination array
 * @param numberOfElements		number of elements in array to be updated
 */
 ...
 * 
 * The dot product is found by multiplying the elements of each array at each position together and then taking the sum of the multiplied values
 * e.g. a[1]*b[1]+ a[2]*b[2] + a[3]*b[3] etc
 * 
 * @param d1									first array in the dot product
 * @param d2									second array in the dot product
 * @param numberOfElements		number of elements in each array
