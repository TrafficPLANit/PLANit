...
public class PhysicalNetwork extends TrafficAssignmentComponent<PhysicalNetwork> {
    ...
    public class Links implements Iterable<Link> {
         ...
         * 
         * @param link
         *            link to be registered in this network
         ...
         * 
         * @param nodeA
         *            the first node in this link
         * @param nodeB
         *            the second node in this link
         * @param length
    ...
    public class LinkSegments implements Iterable<LinkSegment> {
         ...
         * 
         * @param parentLink
         *            the parent link which specified link segment will be registered on
         * @param linkSegment
         *            link segment to be registered
         * @param directionAB
         *            direction of travel
         * @throws PlanItException
         *             thrown if there is an error
