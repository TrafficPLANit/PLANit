...
public class MacroscopicNetwork extends PhysicalNetwork {
	 ...
	 */
	public Pair<MacroscopicLinkSegmentType, Boolean> registerNewLinkSegmentType(@Nonnull final String name,
			final double capacity, final double maximumDensity, final Object externalId,
