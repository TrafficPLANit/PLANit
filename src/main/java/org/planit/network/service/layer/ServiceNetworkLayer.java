...
public class ServiceNetworkLayer extends TopologicalLayerImpl implements TopologicalLayer {
  ...
  private PhysicalNetwork<? extends Node, ? extends Link, ? extends LinkSegment> parentNetworkLayer;
   ...
   */
  protected void setParentNetworkLayer(final PhysicalNetwork<? extends Node, ? extends Link, ? extends LinkSegment> parentNetworkLayer) {
   ...
   * @param serviceNetworkLayerBuilder this is the builder to use for this layer
   */
  protected ServiceNetworkLayer(final IdGroupingToken tokenId, final PhysicalNetwork<? extends Node, ? extends Link, ? extends LinkSegment> parentNetworkLayer,
