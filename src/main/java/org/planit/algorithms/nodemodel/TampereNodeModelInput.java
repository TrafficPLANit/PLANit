 ...
 * of the variable inputs, meaning inputs that can vary during the simulation such as turn sending flows (t_ab), and potentially receiving flows (r_b)
 * 
 */
public class TampereNodeModelInput {
  ...
  private void verifyInputs(TampereNodeModelFixedInput fixedInput, Array2D<Double> turnSendingFlows) throws PlanItException {
      ...
      PlanItException.throwIf(turnSendingFlows.countRows()    != fixedInput.getNumberOfIncomingLinkSegments() || 
