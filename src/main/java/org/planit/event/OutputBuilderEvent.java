...
/**
 * All output builder events should derive from this interface such that the listener can distinguish what to process
 * @author markr
 *
 */
public interface OutputBuilderEvent extends Event {

	/** all output builder events are processed by the OutputBuilderListener
	...
	default public boolean isProcessedBy(EventListener listener) {
		return listener instanceof OutputBuilderListener;
	}
