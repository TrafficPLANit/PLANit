 ...
 * that a change on the link segment level takes precedence over a change on the link segment type, i.e.,
 * the most specific  overwrite is used in the final fundamental diagram applied on the link segment.
 * <p>
 ...
 * with the x-axis (density=0), by explicitly setting the capacity or moving the maximum density point the
 * FD will adjust its backward wave speed to accommodate any change compared to the default computed
 * capacity/maximum density.
 * 
 * @author markr
 */
