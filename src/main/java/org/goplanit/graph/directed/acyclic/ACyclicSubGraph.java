 ...
 *
 */
public interface ACyclicSubGraph<V extends DirectedVertex, E extends EdgeSegment> extends DirectedSubGraph<V, E>, Iterable<V> {
   ...
   */
  @Override
  public abstract ACyclicSubGraph<V, E> clone();
