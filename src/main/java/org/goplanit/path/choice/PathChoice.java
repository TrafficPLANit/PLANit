...
/**
 * The path choice traffic assignment component responsible for the configuration of the path choice methodology
 * and the path associated with this procedure.
 * All derived classes must adhere to this protected constructors signature as the factory expects a
 * traffic component create listener only
 *
 * @author markr
 *
 */
