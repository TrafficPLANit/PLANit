...
import org.goplanit.graph.directed.acyclic.*;
...
public class ShortestBushResultImpl implements ShortestBushResult {
  ...
  /**
   * the preceding edge segment(s) to reach the vertex with the given measured cost. If only a single edge segment is present, that is what is stored, otherwise it is a list of edge segments
   */
