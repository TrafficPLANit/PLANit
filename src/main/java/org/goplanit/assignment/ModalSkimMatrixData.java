...
public final class ModalSkimMatrixData {
   ...
   */
  private final Map<Mode, Map<SkimSubOutputType, OdSkimMatrix>> modalSkimMatrixMap;
   ...
   */
  private ModalSkimMatrixData(final ModalSkimMatrixData simulationData) {
    super();
   ...
   */
  public Map<SkimSubOutputType, OdSkimMatrix> getSkimMatricesByMode(Mode mode) {
   ...
   */
  public void resetAndCreateEmptySkimMatrices(
    ...
    for (var odSkimOutputType : originDestinationOutputTypeConfiguration.getActiveSubOutputTypes()) {
      OdSkimMatrix odSkimMatrix = new OdSkimMatrix(zones, (SkimSubOutputType) odSkimOutputType);
      modalSkimMatrixMap.get(mode).put((SkimSubOutputType) odSkimOutputType, odSkimMatrix);
    }
  }
