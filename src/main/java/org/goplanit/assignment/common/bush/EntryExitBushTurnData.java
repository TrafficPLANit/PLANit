...
/**
 * Track the turn based data of a parent bush by entry exit segment as a key.
 * <p>
 * Only track turn sending flows, splitting rates are deduced from the turn sending flows on the fly.
 * </p>
 * 
 * @author markr
 */
public class EntryExitBushTurnData {

  /** logger to use */
  private static final Logger LOGGER = Logger.getLogger(EntryExitBushTurnData.class.getCanonicalName());
   ...
   */
  public EntryExitBushTurnData(EntryExitBushTurnData other, boolean deepCopy) {
   ...
   * @return shallow copy
   */
  public EntryExitBushTurnData shallowClone() {
    return new EntryExitBushTurnData(this, false);
  }
   ...
   * @return deep copy
   */
  public EntryExitBushTurnData deepClone() {
    return new EntryExitBushTurnData(this, true);
  }
